...
import brand from '../img/brand_01.png';
import brand1 from '../img/brand_02.png';
import brand2 from '../img/brand_03.png';
import brand3 from '../img/brand_04.png';
{/* Start Brands */ }
                      ...
                      <div className="carousel-item active">
                        <div className="row">
                          <div className="col-3 p-md-5">
                            <a href="#"><img className="img-fluid brand-img" src={brand} alt="Brand Logo" /></a>
                          </div>
                          <div className="col-3 p-md-5">
