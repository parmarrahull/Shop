...
import torch from '../img/feature_prod_01.jpg';
import watch from '../img/feature_prod_02.jpg';
import camera from '../img/feature_prod_03.jpg';
                        ...
                        <div className="col-12 col-md-4 mb-4">
                            <div className="card h-100">
                                <a href="shop-single.html">
                                    <img src={torch} className="card-img-top" alt="..." />
                                </a>
